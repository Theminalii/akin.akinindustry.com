    ...
    <footer className="bg-primary text-primary-foreground">
      <div className="container mx-auto px-4 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          <div className="space-y-6">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-primary-foreground/70 text-sm">Tikinti Şirkəti</p>
              </div>
            </div>
            <p className="text-primary-foreground/80 leading-relaxed">
              25 ildən artıq təcrübə ilə Azərbaycanda tikinti sektorunun lider şirkətlərindən biri.
          ...
          <div>
            <h4 className="font-semibold text-lg mb-6">Əsas Səhifələr</h4>
          ...
          <div>
            <h4 className="font-semibold text-lg mb-6">Xidmətlərimiz</h4>
            <ul className="space-y-3">
          ...
          <div>
            <h4 className="font-semibold text-lg mb-6">Əlaqə</h4>
        ...
        <div className="container mx-auto px-4 py-6">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <p className="text-primary-foreground/60 text-sm flex items-center gap-2">
              © {new Date().getFullYear()} Akin Industry. Bütün hüquqlar qorunur.
